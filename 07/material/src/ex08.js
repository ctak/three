...
export default function example() {
  ...
  const ambientTex = textureLoader.load(
    './textures/skull/Ground Skull_ambientOcclusion.jpg',
  );
  const normalTex = textureLoader.load(
    './textures/skull/Ground Skull_normal.jpg',
  );
  const roughnessTex = textureLoader.load(
    './textures/skull/Ground Skull_roughness.jpg',
  );
  const heightTex = textureLoader.load(
    './textures/skull/Ground Skull_height.png',
  );
